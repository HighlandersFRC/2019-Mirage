...
import frc.robot.tools.utility.ControlLoopable;
import frc.robot.tools.utility.MPTalonPIDController;
import frc.robot.tools.utility.PIDParams;
import frc.robot.tools.utility.TalonSRXEncoder;
import frc.robot.tools.utility.TalonSRXFactory;
...
public class Elevator extends Subsystem implements ControlLoopable
{
	...
	public Elevator() {
		try {
			motor1 = TalonSRXFactory.createTalonEncoder(RobotMap.elevatorMainID, (ENCODER_TICKS_TO_INCHES), false, FeedbackDevice.QuadEncoder);
			motor2 = TalonSRXFactory.createPermanentSlaveTalon(RobotMap.elevatorFallowerID, RobotMap.elevatorMainID);
...
//	        }
	...
	private void controlPidWithJoystick() {
		double joystickPosition = ButtonMap.getOperatorLeftYAxis();
	...
	private void controlManualWithJoystick() {
		double joyStickSpeed = ButtonMap.getOperatorLeftYAxis();
